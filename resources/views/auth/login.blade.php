  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to start IES</p>
         @if (count($errors) > 0)
        ...
        {!! csrf_field() !!}
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Email or Username" name="username" value="{!! old('username') !!}">
