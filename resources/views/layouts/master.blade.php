...
<html>
  <head>
    ...
    <!-- IE CSS -->
    <link rel="stylesheet" href="{!! url('public/AdminLTE/dist/css/ie.styles.css') !!}">
    <link rel="stylesheet" href="{!! url('public/AdminLTE/dist/css/animate.css') !!}">
    <!-- iCheck -->
    <link rel="stylesheet" href="{!! url('public/AdminLTE/plugins/iCheck/flat/blue.css') !!}">
    <link rel="stylesheet" href="{!! url('public/AdminLTE/plugins/iCheck/flat/green.css') !!}">
    <!-- Date Picker -->
    <link rel="stylesheet" href="{!! url('public/AdminLTE/plugins/datepicker/datepicker3.css') !!}">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="{!! url('public/AdminLTE/plugins/daterangepicker/daterangepicker-bs3.css') !!}">
  ...
  <body class="hold-transition skin-red sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{!! url('/') !!}" class="logo">
          ...
          <span class="logo-mini"><b>I</b>ES</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Admin</b>IES</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{!! asset('public/uploads/'.Auth::user()->avatar) !!}" class="user-image" alt="User Image">
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016 <a href="{!! url('/') !!}">IES</a>.</strong> Auther: <a href="http://fb.com/xuanbinhnguyen.224" target="_blank">Xuan Binh Nguyen</a>
      </footer>
    ...
    <!-- jQuery Knob Chart -->
    <script src="{!! url('public/AdminLTE/plugins/knob/jquery.knob.js') !!}"></script>
    <!-- daterangepicker -->
    ...
    <!-- FastClick -->
    <script src="{!! url('public/AdminLTE/plugins/fastclick/fastclick.min.js') !!}"></script>
    <!-- AdminLTE App -->
    ...
    <!-- IE script -->
    <script src="{!! url('public/AdminLTE/dist/js/ie.script.js') !!}"></script>
